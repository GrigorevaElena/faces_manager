...
public class PhotoLandmarkDao extends AbstractDao<PhotoLandmark, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property LandmarkType = new Property(1, String.class, "landmarkType", false, "LANDMARK_TYPE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PHOTO_LANDMARK\" (" + //
                ...
                "\"LANDMARK_TYPE\" TEXT," + // 1: landmarkType
    ...
    protected void bindValues(SQLiteStatement stmt, PhotoLandmark entity) {
        ...
        String landmarkType = entity.getLandmarkType();
        if (landmarkType != null) {
            stmt.bindString(2, landmarkType);
        }
    ...
    public PhotoLandmark readEntity(Cursor cursor, int offset) {
        PhotoLandmark entity = new PhotoLandmark( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // landmarkType
    ...
    public void readEntity(Cursor cursor, PhotoLandmark entity, int offset) {
        ...
        entity.setLandmarkType(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
