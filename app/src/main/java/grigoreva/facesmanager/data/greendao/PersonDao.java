...
public class PersonDao extends AbstractDao<Person, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property IsContact = new Property(3, boolean.class, "isContact", false, "IS_CONTACT");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PERSON\" (" + //
                ...
                "\"IS_CONTACT\" INTEGER NOT NULL );"); // 3: isContact
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Person entity) {
        ...
        stmt.bindLong(4, entity.getIsContact() ? 1L: 0L);
    }
    ...
    public Person readEntity(Cursor cursor, int offset) {
        Person entity = new Person( //
            ...
            cursor.getShort(offset + 3) != 0 // isContact
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Person entity, int offset) {
        ...
        entity.setIsContact(cursor.getShort(offset + 3) != 0);
     }
